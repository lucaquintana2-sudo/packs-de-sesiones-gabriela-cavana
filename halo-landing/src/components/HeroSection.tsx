...
const brandList = [...heroBrands, ...heroBrands]
    ...
    <div className="flex-1 px-6 pt-20 pb-6 flex items-end">
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-start justify-start h-full p-12 pt-36">
          ...
          {/* Join us button */}
          <button className="inline-flex items-center gap-3 bg-black text-white text-base md:text-lg font-medium pl-8 pr-2 py-2 rounded-full hover:bg-gray-800 transition-colors duration-200 cursor-pointer border-0">
            Join us
